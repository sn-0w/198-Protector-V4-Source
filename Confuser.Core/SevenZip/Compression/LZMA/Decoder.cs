...
namespace SevenZip.Compression.LZMA
{
	...
	{
		// Token: 0x06000073 RID: 115 RVA: 0x00005A14 File Offset: 0x00003C14
		public Decoder()
		{
		...
		// Token: 0x06000074 RID: 116 RVA: 0x00005B04 File Offset: 0x00003D04
		...
		// Token: 0x06000075 RID: 117 RVA: 0x00005EF0 File Offset: 0x000040F0
		...
		// Token: 0x06000076 RID: 118 RVA: 0x00005F7C File Offset: 0x0000417C
		...
		// Token: 0x06000077 RID: 119 RVA: 0x00005FD4 File Offset: 0x000041D4
		...
		// Token: 0x06000079 RID: 121 RVA: 0x00006054 File Offset: 0x00004254
		...
		// Token: 0x0600007A RID: 122 RVA: 0x000061A4 File Offset: 0x000043A4
		...
		{
			// Token: 0x0600007B RID: 123 RVA: 0x000061CC File Offset: 0x000043CC
			...
			// Token: 0x0600007C RID: 124 RVA: 0x0000621C File Offset: 0x0000441C
			public void Init()
			{
				this.m_Choice.Init();
			...
			// Token: 0x0600007D RID: 125 RVA: 0x0000628C File Offset: 0x0000448C
		...
		{
			// Token: 0x0600007F RID: 127 RVA: 0x0000635C File Offset: 0x0000455C
			...
			// Token: 0x06000080 RID: 128 RVA: 0x000063EC File Offset: 0x000045EC
			public void Init()
			{
				uint num = 1U << this.m_NumPrevBits + this.m_NumPosBits;
				for (uint num2 = 0U; num2 < num; num2 += 1U)
			...
			// Token: 0x06000081 RID: 129 RVA: 0x00006430 File Offset: 0x00004630
			private uint GetState(uint pos, byte prevByte)
			{
				return ((pos & this.m_PosMask) << this.m_NumPrevBits) + (uint)(prevByte >> 8 - this.m_NumPrevBits);
			}

			// Token: 0x06000082 RID: 130 RVA: 0x00006464 File Offset: 0x00004664
			...
			// Token: 0x06000083 RID: 131 RVA: 0x00006490 File Offset: 0x00004690
			...
			{
				// Token: 0x06000085 RID: 133 RVA: 0x000023A1 File Offset: 0x000005A1
				public void Create()
				{
					this.m_Decoders = new BitDecoder[768];
				}

				// Token: 0x06000086 RID: 134 RVA: 0x000064C0 File Offset: 0x000046C0
				public void Init()
				{
					for (int i = 0; i < 768; i++)
					{
				...
				// Token: 0x06000087 RID: 135 RVA: 0x000064F4 File Offset: 0x000046F4
				...
				// Token: 0x06000088 RID: 136 RVA: 0x00006530 File Offset: 0x00004730
